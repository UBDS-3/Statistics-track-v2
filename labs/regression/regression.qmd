...
As a running example to learn about more complex linear models, we will be using a dataset which compares the different frictional coefficients on the different legs of a spider. Specifically, we are interested in **comparing the effect of pulling and pushing motions for different leg pairs on friction.** The original paper from which the data was provided is:
...
We can make a boxplot summarizing the measurements for each of the eight pairs:
