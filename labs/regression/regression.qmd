...
### Contrasts and interactions in linear regression

As a running example, we use a dataset which compares the frictional coefficients on the different legs of a spider. Specifically, we will ask whether more friction comes from a pushing or pulling motion of the leg. The original paper from which the data originate:
